...
/**
 * <p>Копия из androidx.appcompat:appcompat:1.3.1 для использования вместе с {@link DrawerLayout}
 *
 ...
 * </ul>
 *
 * <p>Call {@link #syncState()} from your <code>Activity</code>'s onPostCreate to synchronize the
...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
     ...
     * onPostCreate method to synchronize after
     ...
     */
    @Override
    public void onDrawerStateChanged(int newState, @Nullable View drawerView) {
    }
